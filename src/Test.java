...
public class Test {
    ...
    public static void main(String args[]) throws Exception {
        ...
        System.out.println("<--Pi4J--> MCP3208 ... started.");
        ...
        final GpioPinAnalogInput input=gpio.provisionAnalogInputPin(provider, MCP3208Pin.CH0, "CH0");
        ...
        System.out.println("Exiting MCP3208");
    }
}
